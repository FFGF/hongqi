...
<div class="wrap">
    ...
    <div class="platCon">
        <div class="platState white">
            <div class="platTitle"><h2>前台收款</h2><a href="<?php echo U('admin/student/indexindex');?>"><img src="/Public/Admin/Images/return.png" style="margin-left: 200px"></a></div>
            ...
            <div class="recordCou">
                ...
                <!--收费搜索窗口-->
                <?php if(!empty($charge_standard_name)): ?><div class="selectList">
                    ...
                    <?php if(!empty($result_charge_task)): ?><div id="student_charge_task">
                            <h2><?php echo ($result_charge_task['student_name']); ?></h2>
                            <form action="<?php echo U('admin/charge/saveStudentReceiveItem');?>" method="post" id="saveStudentReceiveItem">
                ...
                <?php if(!empty($result_charge_standard)): ?><table class="table" id="chargeList">
                        ...
                        <?php if(is_array($result_charge_standard)): $i = 0; $__LIST__ = $result_charge_standard;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                                <td><a href="<?php echo U('admin/charge/receiveItem',array('charge_standard_name'=>$item['charge_standard_name']));?>"><?php echo ($item['charge_standard_name']); ?></a></td>
                                <td><?php echo ($item['teacher_name']); ?></td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
                    </table><?php endif; ?>
